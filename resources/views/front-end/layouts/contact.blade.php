    ...
    <div class="container">
      <div class="flex-w flex-tr">
        <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
          ...
          <form method="post" action="{{route('communicate')}}" id="form">
            @csrf
              ...
              <div class="bor8 m-b-20 how-pos4-parent">
                  ...
                  <img class="how-pos4 pointer-none" src="{{asset('public/front-end')}}/images/icons/user.png" alt="ICON">
              ...
              <div class="bor8 m-b-20 how-pos4-parent">
                  ...
                  <img class="how-pos4 pointer-none" src="{{asset('public/front-end')}}/images/icons/icon-email.png" alt="ICON">
                  <font color="red"><b></b></font>
              </div>
              ...
              <div class="bor8 m-b-20 how-pos4-parent">
                  ...
                  <img class="how-pos4 pointer-none" src="{{asset('public/front-end')}}/images/icons/mobile.png" alt="ICON">
                  <font color="red"><b></b></font>
              </div>
