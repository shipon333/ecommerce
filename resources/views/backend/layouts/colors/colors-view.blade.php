          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Color List
                </h3>
                <a href="{{route('colors.add')}}" class="btn btn-success float-right"><i class="fa fa-plus-circle">Add Color</i></a>
                ...
                <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                  ...
                  <tbody>
                    ...
                    <tr class="{{$color->id}}">
                      ...
                      <td>{{$color->name}}</td>
                      <td>
                        <a href="{{route('colors.edit',$color->id)}}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                        @php
