          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Add Contact
                </h3>
                <a href="{{route('contacts.view')}}" class="btn btn-success float-right"><i class="fa fa-list">Contact List</i></a>
              </div><!-- /.card-header -->
              <div class="card-body">

                <form action="{{route('contacts.store')}}" method="post" id="valideform" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="form-group col-md-4">
                      <label for="address">Sddress</label>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="email" class="form-control" id="email" name="email" placeholder="Your Emal Address">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" id="google" name="google" placeholder="Gooogle Link">
