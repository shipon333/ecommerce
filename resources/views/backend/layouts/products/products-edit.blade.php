          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="{{route('products.update',$editproducts->id)}}" method="post" id="valideform" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select name="brand_id" id="brand_id" class="form-control select2">
                        ...
                        <option value="{{$brand->id}}" {{($editproducts->brand_id==$brand->id)?"selected":''}}>{{$brand->name}}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group col-md-4">
                      <label for="name">Name</label>
                      <input type="text" class="form-control" id="name" value="{{$editproducts->name}}" name="name" placeholder="Product Name">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="number" class="form-control" value="{{$editproducts->price}}" id="price" name="price" placeholder="Product Price">
                      <font color="red">{{($errors->has('price'))?($errors->first('price')):' '}}</font>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="short_desc">Short Description</label>
                      <br>
                      <textarea class="form-control" name="short_desc" id="short_desc" cols="69" rows="5">{{$editproducts->sort_desc}}</textarea>
                      <font color="red">{{($errors->has('short_desc'))?($errors->first('short_desc')):' '}}</font>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="long_desc">Long Description</label>
                      <br>
                      <textarea class="form-control" name="long_desc" id="long_desc" cols="69" rows="5">{{$editproducts->long_desc}}</textarea>
                    ...
                    <div class="form-group col-md-4">
                      <img src="{{(!empty($editproducts->image))?url('public/upload/product_image/'.$editproducts->image):url('public/download.jpg')}}" id="showimage" alt="" width="200px" height="200px">
                    </div>
                    <div class="form-group col-md-4">
