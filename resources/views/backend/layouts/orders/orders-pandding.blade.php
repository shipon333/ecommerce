  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Pandding Order</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Panddin Order List
                </h3>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr class="{{$order->id}}">
                      ...
                      <td> 
                        <a title="Approve" id="approve" class="btn btn-sm btn-primary" href="{{route('orders.approve')}}" data-token="{{csrf_token()}}" data-id="{{$order->id}}"><i class="fa fa-check"></i></a>
                      </td>
